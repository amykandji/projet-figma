     ...
     <section class="section-2">
        <div class="les-images">
            <div class="image-mere">
                <img src="image/Rectangle r39.png" alt="">
            </div>
            <div class="images-enfants">
                <img src="image/Rectangle i40.png" alt="">
                <img src="image/Rectangle -41.png" alt="">
                <img src="image/Rectangle =42.png" alt="">
            </div>
        </div>
        <div class="box-deux">
            <h1 class="p1">Siena and Surroundings</h1>
    ...
    <div class="gallery-container">
        ...
        <div class="gallery">
            <div class="gallery-item large">
                <img src="image/Rectangle s43.png" alt="Paysage verdoyant">
            </div>
            <div class="gallery-column">
                <div class="gallery-item">
                    <img src="image/Rectangle 4l4.png" alt="Cave à vin">
                </div>
                <div class="gallery-item">
                    <img src="image/Rectangle 45i (1).png" alt="Cyclistes en nature">
                </div>
            </div>
            <div class="gallery-item tall">
                <img src="image/Rectangleq 46.png" alt="Ville historique">
            </div>
        </div>
